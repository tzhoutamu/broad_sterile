...
chi2_BS_2 = np.load(datadir_pros+'BroadSterileChi2_test1.npy')
chi2_BS_3 = np.load(datadir_dane+'BroadSterileChi2_test1.npy')
...
plot.suptitle(r'Global best fit: $\tilde{b}=%.3f$, Total $\chi^2=%.2f$'%(bestb_1, bestfit_1), fontsize=13)
plot.savefig(plotdir+'BroadSterileChi2b_1e-4.png')