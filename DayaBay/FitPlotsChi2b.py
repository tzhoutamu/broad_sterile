...
homedir = os.path.realpath(__file__)[:-len('DayaBay/FitPlotsChi2b.py')]
...
axx.plot(b_ax_1,min_chi2_BS_1-bestfit, label = 'DayaBay', color = color1)
axx.legend(bbox_to_anchor=(2e-4, 1), loc="upper left", ncol=1, fontsize=15)
plot.suptitle(r'DayaBay best fit: $\tilde{b}=%.3f$, Total $\chi^2=%.2f$'%(bestb, bestfit), fontsize=13)
plot.savefig(homedir+'DayaBay/Figures/BroadSterileChi2b3.png')