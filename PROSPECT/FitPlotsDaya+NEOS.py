...
homedir = os.path.realpath(__file__)[:-len('PROSPECT/FitPlotsDaya+NEOS.py')]
...
plotdir = homedir+'PROSPECT/Figures/Daya+NEOS/'
...
mass_PW = np.load(datadir_neos+'PWSterileMass_p2.npy')
angle_PW = np.load(datadir_neos+'PWSterileAngle_p2.npy')
...
b_BS = np.load(datadir_neos+'BroadSterileb_frac.npy')
chi2_BS = np.add(np.load(datadir_neos+'BroadSterileChi2_frac.npy'),np.load(datadir_daya+'BroadSterileChi2_frac.npy'))
...
ax_comp.annotate('DB+NEOS', xy = (5e-3,1.5), size = 42)
