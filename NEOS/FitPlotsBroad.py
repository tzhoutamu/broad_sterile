...
homedir = os.path.realpath(__file__)[:-len('NEOS/FitPlotsBroad.py')]
...
print('Standard')
# We load the data
mass_PW = np.load(datadir+'PWSterileMass_int.npy')
angle_PW = np.load(datadir+'PWSterileAngle_int.npy')
chi2_PW = np.load(datadir+'PWSterileChi2_int.npy')
