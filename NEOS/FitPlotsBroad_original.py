...
homedir = os.path.realpath(__file__)[:-len('NEOS/FitPlotsBroad_original.py')]
...
# ------------------------------------------------------
# STERILE BROAD STERILE CONTOUR - MARGINALIZING OVER B
# ------------------------------------------------------
...
chi2_PW_reshaped = np.reshape(chi2_PW, (30, 30, 10))
