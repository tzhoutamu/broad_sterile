...
np.save('./PlotData/BroadSterileMass.npy', mass_data)
np.save('./PlotData/BroadSterileAngle.npy', angle_data)
np.save('./PlotData/BroadSterileb.npy', b_data)
...
if __name__ == '__main__':
    ...
    np.save('./PlotData/BroadSterileChi2.npy', chi2_data[:])
    end = time.time()
    pool.close()
